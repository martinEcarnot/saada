...
load("~/Documents/INRA/melanges/2019/saada2019_sp")
...
# kW=orthEf2(mo29,"xp",c(4),2)  # mono2=orthEf(mono2,mono2,"xp",c(1,5,9),1)
...
for (i in 1:ngeno) { #round(seq(31,ngeno, 1))) {  # 1:ngeno) {  # 
  print(i)
  for (j in 1:ngeno) {  #round(seq(30,ngeno-1,1))) {  # 1:ngeno) {
